const Document = require('../data.model').Course;
...
exports.findCoursePage = function (req, res) {
    let courselink = req.params.courselink
    Document.find({ courselink: courselink }, (err, result) => {
        if (!err)
            res.json({ msg: 'Data Retrive Success', data: result });
        else
            res.json({ msg: 'Data Retrive failed', err: err });
...
exports.delete = function (req, res) {
    Document.findByIdAndRemove(req.body._id, (err, result) => {
